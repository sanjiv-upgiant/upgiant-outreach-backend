...
export const sendVerificationEmail = async (to: string, token: string): Promise<void> => {
  ...
  const html = `<div style="margin:30px; padding:30px; border:1px solid black; border-radius: 20px 10px;"><h4><strong>Hi,</strong></h4>
 ...
 * @returns {Promise<void>}
 */
export const sendAccountCreated = async (to: string): Promise<void> => {
