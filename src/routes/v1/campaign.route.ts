...
import { createCampaignValidation, createEmailTemplateFetchValidation } from '../../modules/campaign/campaign.validatation';
...
router.post("/get-templates-from-category", auth(), validate(createEmailTemplateFetchValidation), getEmailTemplatesController)
